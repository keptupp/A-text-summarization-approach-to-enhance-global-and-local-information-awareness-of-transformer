...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, e_outputs, src_mask, trg_mask,cnn_outputs,src_pool_mask):
        x2 = self.norm_1(x)
        ...
        x2 = self.norm_3(x)
        x = x + self.dropout_3(self.attn_3(x2, cnn_outputs, cnn_outputs, src_pool_mask))  # 将卷积后的编码放入解码器
